...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      endActivities: [true, false, false, true, false, false, false, false, false, false, false, false]
      // endActivities: [true, true, true, true, true, true, true, true, true, true, true, false]
    }
  }
